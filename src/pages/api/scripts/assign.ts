...
//     const availableScriptIds = await getAvailableScriptIds();
...
//     console.log(
//       "availableSituational,availableFormal, availableQAScenario",
//       availableSituational,
//       availableFormal,
//       availableQAScenario
//     );
...
//       situationalUpdates[script.id] = true;
//     });
//     selectedFormal.forEach((script) => {
//       formalUpdates[script.id] = true;
//     });
//     selectedQAScenario.forEach((script) => {
//       qaScenarioUpdates[script.id] = true;
//     });
...
//       (script) => {
//         const progressRef = doc(db, "users", userId, "progress", script.id);
...
// // 사용 가능한 스크립트 ID들 가져오기
// async function getAvailableScriptIds() {
...
//       if (!isUsed) {
//         availableIds[scriptType].push(scriptId);
//       }
//     });
//   });

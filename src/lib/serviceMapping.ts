...
export const SERVICE_CONFIG = {
  ...
  //신규
  대중교통: {
    icon: "M12,2C16.42,2 20,3 20,7V15C20,18.87 16.87,20 13,20L15,22V23H9V22L11,20C7.13,20 4,18.87 4,15V7C4,3 7.58,2 12,2M6,8H18V12H6V8Z",
    iconColor: "cardCyan",
    description: "대중교통 관련",
  },
  이동정보: {
  ...
  //신규
  공공서비스: {
    icon: "M12,2L2,7V9H4V20H10V14H14V20H20V9H22V7L12,2Z",
    iconColor: "cardGray",
    description: "공공서비스 관련",
  },
};
